...
export default function App() {
  ...
  // NUEVO: Estado para controlar la pantalla de introducción
  ...
  return (
    <>
      ...
      {/* Contenedor principal: Oculta el scroll si la intro está activa */}
      <div className={`app-container ${showSplash ? 'no-scroll-intro' : ''}`}>
